...
# Executando o comando SQL para selecionar as pessoas que nasceram neste século
df_select = spark.sql("SELECT Nomes, AnoNascimento FROM pessoas WHERE AnoNascimento >= 2000 LIMIT 10")
